...
const vizMenus = [
  {
    ...
    title: "Univariate",
    desc: "Histogram, Box Plot, Bar Chart, Pie Chart.",
    badge: null,
  },
  {
    ...
    title: "Bivariate",
    desc: "Scatter Plot dan Line Chart.",
    badge: null,
  },
  {
    ...
    title: "Heatmap",
    desc: "Matriks korelasi Pearson (semua kolom numerik).",
    badge: null,
  },
  {
    ...
    title: "Time Series",
    desc: "Visualisasi data berbasis waktu (segera hadir).",
    badge: "Soon",
  },
];
    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="mt-1 text-muted-foreground text-sm">
          7 grafik interaktif Highcharts: Histogram, Box Plot, Bar, Pie, Scatter, Line, Heatmap.
        </p>
      </div>
            ...
            <Card className="cursor-pointer transition-all hover:border-primary hover:shadow-sm">
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  {m.badge ? <Badge className="text-xs">{m.badge}</Badge> : null}
                </div>
